Title: Instalación de CentOS para virtualizar
Slug: centos-instalacion-para-virtualizar
Summary: Instalar CentOS con lo mínimo necesario para virtualizar con KVM. Teniendo en mente que sólo va a llegar a Terminal, es decir, sin interfaz gráfica o GUI. La administración será vía OpenSSH y por el Administrador de Virtualizaciones desde otro equipo.
Tags: software libre
Date: 2014-01-30 10:20
Modified: 2014-01-30 10:20
Category: apuntes
Preview: centos-logo-icon.png
...
<img class="img-fluid" src="administrador-virtualizaciones-1.png" alt="Administrador de Virtualizaciones">

Establezca la conexión vía OpenSSH. Le solicitará la contraseña _root_:

<img class="img-fluid" src="administrador-virtualizaciones-2-nueva-conexion.png" alt="Administrador de Virtualizaciones nueva conexion">

Verifique que en los detalles se use la configuración de red con el _bridge_ **br0**:

<img class="img-fluid" src="administrador-virtualizaciones-3-detalles-redes.png" alt="Administrador de Virtualizaciones detalle">
