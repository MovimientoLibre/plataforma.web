...
![Administrador de Virtualizaciones](administrador-virtualizaciones-1.png)

Establezca la conexión vía OpenSSH. Le solicitará la contraseña _root_:

![Administrador de Virtualizaciones nueva conexion](administrador-virtualizaciones-2-nueva-conexion.png)

Verifique que en los detalles se use la configuración de red con el _bridge_ **br0**:

![Administrador de Virtualizaciones detalle](administrador-virtualizaciones-3-detalles-redes.png)
